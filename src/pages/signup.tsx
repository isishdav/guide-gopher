        ...
        <Container className="max-w-[480px]">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2 text-left">
              <label className="text-foreground text-sm font-semibold ml-1">Full Name</label>
              <Input
                type="text"
            ...
            <div className="space-y-2 text-left">
              <label className="text-foreground text-sm font-semibold ml-1">Work Email</label>
              <Input
                type="email"
            ...
            <div className="space-y-2 text-left">
              <label className="text-foreground text-sm font-semibold ml-1">Password</label>
              <Input
                type="password"
