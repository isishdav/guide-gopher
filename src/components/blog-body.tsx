...
export function BlogBody({ content }: { content: string }) {
    return (
        <div className={`
          ...
          [&_h1]:text-3xl [&_h1]:md:text-4xl [&_h1]:font-extrabold [&_h1]:mt-8 [&_h1]:mb-6 [&_h1]:text-foreground
          [&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:text-foreground
          [&_h3]:text-xl [&_h3]:md:text-2xl [&_h3]:font-bold [&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:text-foreground
          [&_h4]:text-lg [&_h4]:md:text-xl [&_h4]:font-semibold [&_h4]:mt-6 [&_h4]:mb-2 [&_h4]:text-foreground
          ...
          [&_blockquote_p]:text-lg [&_blockquote_p]:text-foreground [&_blockquote_p]:font-semibold

          [&_pre]:bg-gray-900 [&_pre]:text-gray-100 [&_pre]:p-4 [&_pre]:rounded-none [&_pre]:overflow-x-auto [&_pre]:my-6
          ...
          [&_img]:rounded-none [&_img]:shadow-md [&_img]:my-8
        `}>
