    ...
    return (
        <section className="py-12 md:py-[60px]">
            <Container className="md:space-y-20 space-y-12">
                ...
                <div className="relative bg-card rounded-none border border-border p-6 md:p-12 overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-12 gap-8 items-center">
                        ...
                        {/* Right Image */}
                        <div className="relative aspect-[4/3] md:aspect-[16/10] lg:aspect-square overflow-hidden rounded-none">
                            <AnimatePresence mode="wait">
                                <motion.div
                                    key={activeTab}
