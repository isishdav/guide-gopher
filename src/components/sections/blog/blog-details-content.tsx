            ...
            <Container className="flex flex-col lg:flex-row justify-between md:gap-10 gap-6 py-[60px]">
                ...
                <div className="max-w-[717px]" ref={contentRef}>
                    ...
                    <div className="lg:hidden mb-12">
                        <AnimateOnView blur once delay={0.4} className="bg-secondary border border-border rounded-none p-8">
                            ...
                            <nav className="space-y-4">
                                {headings.length > 0 ? (
                                    ...
                                    <p className="text-foreground/20 text-sm">No sections found.</p>
                                )}
                            </nav>
                        </AnimateOnView>
                    </div>
                ...
                <aside className="max-w-[400px] w-full lg:sticky lg:top-[100px] lg:h-fit space-y-6">
                    ...
                    <AnimateOnView blur once delay={0.4} className="bg-secondary border border-border rounded-none p-8 hidden lg:block">
                        <h3 className="text-foreground text-xl font-bold mb-6">Table of content</h3>
                        <nav className="space-y-4">
                            {headings.length > 0 ? (
                                headings.map((heading) => (
                    ...
                    {/* Newsletter */}
                    <AnimateOnView blur once delay={0.5} className="bg-secondary border border-border rounded-none p-8">
                        ...
                        <div className="space-y-4">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-secondary border border-border rounded-none px-6 py-4 text-foreground focus:outline-none focus:border-primary/50 transition-colors"
                                />
                            </div>
