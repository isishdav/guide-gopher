          ...
          {collections.map((collection, index) => (
            ...
            >
              <Link
                ...
                className="card-lux relative block h-full w-full overflow-hidden rounded-none rounded-none bg-secondary border border-border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
              >
                <img
